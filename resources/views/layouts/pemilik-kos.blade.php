    ...
    <div class="aside-container">
      <aside class="aside">
        <div class="brand-logo-container">
          <h2 class="brand-logo">PEMILIK KOS</h2>
        </div>
        <div class="menu-container">
          <ul class="nav-link-container" style="">
            ...
            <li>
              <a href="{{ url('/pemilik-kos') }}" class="aside-menu-link {{ request()->is('pemilik-kos') ? 'aside-menu-link-active' : ''  }}">Dashboard</a>
            </li>
            
            <li><a href="{{ url('/pemilik-kos/kos-saya') }}" class="aside-menu-link {{ request()->is('pemilik-kos/kos-saya*') ? 'aside-menu-link-active' : ''  }}">Kos Saya</a></li>
